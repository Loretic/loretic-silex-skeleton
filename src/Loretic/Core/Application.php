...
class Application extends SilexApplication
{
    ...
    {
        $controllerPath = 'src/Loretic/Core/Controller';
        $finder = new Finder();
        ...
        foreach ($finder as $file) {
            ...
            $class = 'Loretic\\Core\\Controller\\'.$cleanedPathName;
    ...
    private function configureProviders()
    {
        ...
        $this->register(new TwigServiceProvider(), array(
            'twig.path' => $this['resources_dir'].'/views',
        ));
        ...
        */
        ...
        $this->register(new MonologServiceProvider(), array(
            'monolog.logfile' => $this['resources_dir'].'/logs/development.log',
        ));
        ...
        $this['translator'] = $this->share($this->extend('translator', function($translator) {
            ...
            $translator->addResource('yaml', $this['resources_dir'].'/translations/en.yml', 'en');
    ...
    private function configureParameters()
    {
        ...
        $this['resources_dir'] = $this['root_dir'].'/resources';
